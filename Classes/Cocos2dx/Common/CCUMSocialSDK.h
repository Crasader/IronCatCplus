...
public:
	 ...
	 */
	void authorize(int platform, std::function<void(int,int,const map<string, string>&)> callback);
	 ...
	 */
	void deleteAuthorization(int platform, std::function<void(int,int,const map<string, string>&)> callback);
