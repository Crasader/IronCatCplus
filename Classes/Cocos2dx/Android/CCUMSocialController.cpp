...
// 授权回调
std::function<void(int,int,const map<string, string>&)> authCallback = NULL;
// 分享回调
std::function<void(int,int,const string&)> shareCallback = NULL;
 ...
 */
void doAuthorize(int platform, std::function<void(int,int,const map<string, string>&)> callback) {
 ...
 */
void deletePlatformAuthorization(int platform, std::function<void(int,int,const map<string, string>&)> callback) {
	authCallback = callback;
	JniMethodInfo mi;
 ...
 */
void doOpenShare(std::function<void(int,int,const string&)> callback) {
 ...
 * @param callback 分享回调，具体参考CCUMTypeDef.h中的定义
 */
void doDirectShare(int platform, std::function<void(int,int,const string&)> callback) {
	shareCallback = callback;
	if (shareCallback != NULL) {
		CCLog("#### 授权回调不为NULL");
