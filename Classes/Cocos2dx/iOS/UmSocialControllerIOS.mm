...
void UmSocialControllerIOS::authorize(int platform, std::function<void(int,int,const map<string, string>&)> callback){
...
void UmSocialControllerIOS::deleteAuthorization(int platform, std::function<void(int,int,const map<string, string>&)> callback){
...
void UmSocialControllerIOS::openShareWithImagePath(vector<int>* platforms, const char* text, const char* imagePath,std::function<void(int,int,const string&)> callback){
...
void UmSocialControllerIOS::directShare(const char* text, const char* imagePath,int platform, std::function<void(int,int,const string&)> callback){
