...
#define IDD_COCOS2DXWEBBROWSER_DIALOG	102
#define IDD_ABOUTBOX			103
#define IDM_ABOUT				104
#define IDM_EXIT				105
#define IDR_MAINFRAME			128
#define IDD_COCOS2DXWEBBROWSER_DIALOG	102
#define IDI_COCOS2DXWEBBROWSER			107
#define IDI_SMALL				108
#define IDC_COCOS2DXWEBBROWSER			109
// 全局变量:
                     ...
                     int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_COCOS2DXWEBBROWSER, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_COCOS2DXWEBBROWSER));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_COCOS2DXWEBBROWSER));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_COCOS2DXWEBBROWSER);
